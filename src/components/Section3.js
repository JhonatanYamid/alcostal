        ...
        <div>
            ...
            <div className='w-full flex flex-col bg-teal-500 md:-mt-24'>
                ...
                <div className='md:px-10 flex flex-row pt-5 flex-wrap justify-center pb-8 md:pb-0'>
                    ...
                    <ItemCategory
                        title="Verduras"
                        image="/lottieFiles/63272-walking-avocado.json" />
                    <ItemCategory
                        title="Frutas"
                        image="/lottieFiles/62266-walking-orange.json" />
                    <ItemCategory
                        title="Plantas"
                        image="/lottieFiles/62761-walking-pothos.json" />
                    <ItemCategory
                        title="Animales"
                        image="/lottieFiles/56305-cool-turkey.json" />
                </div>
            </div>
            <div>
                <svg viewBox="0 0 1440 320">
