        ...
        <nav className="flex items-center justify-between flex-wrap fixed inset-x-0 md:px-20 navbar-inactive px-5 z-50" id="navbar">
            ...
            <div
                ...
                <div className='flex flex-row justify-center items-center text-sm text-white font-semibold'>
                    <Link href="/">
                        <a href="#" className="px-4 mr-2 py-2 leading-none border rounded bg-teal-500 border-white hover:border-transparent hover:bg-teal-600 mt-4 lg:mt-0">Ingresar</a>
                    </Link>
                    <Link href="/">
